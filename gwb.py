...
(function() {{
    ...
    turfScript.onload = function() {{
        ...
        function initMap() {{
            ...
            // Add base tile layer
            L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{{z}}/{{y}}/{{x}}',{{attribution: 'Tiles © Esri', detectRetina: true, pane:maskPane, noWrap: true}}).addTo({map_var})        
